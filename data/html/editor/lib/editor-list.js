...
(function (o, n) {
  typeof exports == "object" && typeof module < "u"
    ...
    ? define(n)
    : ((o = typeof globalThis < "u" ? globalThis : o || self), (o.List = n()));
})(this, function () {
  "use strict";
  const o = "",
    n =
  ...
  class d {
        ...
        this._data.items.length
          ? this._data.items.forEach((e) => {
              this._elements.wrapper.appendChild(
                this._make("li", this.CSS.item, { innerHTML: e })
              );
            })
    ...
    makeMainTag(e) {
      const t =
          e === "ordered" ? this.CSS.wrapperOrdered : this.CSS.wrapperUnordered,
        r = e === "ordered" ? "ol" : "ul";
    ...
    set data(e) {
      e || (e = {}),
        (this._data.style =
          e.style || this.settings.find((r) => r.default === !0).name),
